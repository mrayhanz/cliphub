...
<div class="w-full space-y-6 pb-20 pt-2">
    ...
    <div class="bg-[#111111] border border-[#1f1f1f] rounded-[1.5rem] relative overflow-hidden">
        {{-- Top decoration glow --}}
        <div class="absolute -top-32 -left-32 w-64 h-64 bg-emerald-600/10 rounded-full blur-[80px] pointer-events-none z-0"></div>
        ...
        <form action="{{ route('brand.campaigns.store') }}" method="POST" enctype="multipart/form-data" class="relative z-10 flex flex-col">
            ...
            <div class="p-6 lg:p-8 border-b border-white/5 space-y-8">
                <div class="flex items-center gap-4">
                    <div class="w-10 h-10 rounded-xl bg-emerald-500/10 flex items-center justify-center border border-emerald-500/20 text-emerald-400 font-black text-lg shrink-0">1</div>
                    <div>
                ...
                <div class="flex flex-col gap-6">
                    <div class="w-full">
                        <label class="block text-xs font-extrabold text-[#a1a1aa] mb-2 tracking-wide">Nama Campaign <span class="text-emerald-500">*</span></label>
                        <input type="text" name="title" class="w-full bg-[#000] border border-[#27272a] rounded-2xl px-5 py-3.5 text-sm text-white font-medium transition-all duration-200 focus:outline-none focus:border-emerald-400 focus:ring-4 focus:ring-emerald-500/15 placeholder:text-[#52525b] placeholder:font-medium" placeholder="Contoh: Promo Flash Sale Spesial Lebaran" required>
                    </div>
                    
                    <div class="flex flex-col sm:flex-row gap-6 w-full">
                        <div class="flex-1">
                            <label class="block text-xs font-extrabold text-[#a1a1aa] mb-2 tracking-wide">Jenis Campaign <span class="text-emerald-500">*</span></label>
                            <select name="type" class="w-full bg-[#000] border border-[#27272a] rounded-2xl px-5 py-3.5 text-sm text-white font-medium transition-all duration-200 focus:outline-none focus:border-emerald-400 focus:ring-4 focus:ring-emerald-500/15 cursor-pointer appearance-none">
                        ...
                        <div class="flex-1">
                            <label class="block text-xs font-extrabold text-[#a1a1aa] mb-2 tracking-wide">Batas Kuota Kreator (Slot) <span class="text-emerald-500">*</span></label>
                            <input type="number" name="slots" class="w-full bg-[#000] border border-[#27272a] rounded-2xl px-5 py-3.5 text-sm text-white font-medium transition-all duration-200 focus:outline-none focus:border-emerald-400 focus:ring-4 focus:ring-emerald-500/15 placeholder:text-[#52525b] placeholder:font-medium" placeholder="Contoh: 50" required>
                        </div>
                    </div>

                    <div class="w-full">
                        <label class="block text-xs font-extrabold text-[#a1a1aa] mb-2 tracking-wide">Banner / Gambar Thumbnail <span class="text-emerald-500">*</span></label>
                        <div class="border border-dashed border-white/15 rounded-2xl p-10 text-center cursor-pointer bg-black/50 transition-all duration-200 hover:border-emerald-500/50 hover:bg-emerald-500/5 hover:shadow-[inset_0_0_0_1px_rgba(16,185,129,0.1)] flex flex-col items-center justify-center" onclick="document.getElementById('thumbnail-upload').click()">
                            ...
                            <p class="text-xs text-emerald-400 mt-3 font-semibold" id="file-name"></p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="p-6 lg:p-8 border-b border-white/5 space-y-8 bg-black/40">
                <div class="flex items-center gap-4">
                    <div class="w-10 h-10 rounded-xl bg-emerald-500/10 flex items-center justify-center border border-emerald-500/20 text-emerald-400 font-black text-lg shrink-0">2</div>
                    <div>
                ...
                <div class="flex flex-col gap-6">
                    <div class="w-full">
                        <label class="block text-xs font-extrabold text-[#a1a1aa] mb-2 tracking-wide">Tujuan Singkat & Cara Kerja <span class="text-emerald-500">*</span></label>
                        <p class="text-[9px] text-slate-500 mb-2 leading-relaxed">Penjelasan awal agar kreator paham garis besarnya secara cepat.</p>
                        <textarea name="desc" rows="3" class="w-full bg-[#000] border border-[#27272a] rounded-2xl px-5 py-3.5 text-sm text-white font-medium transition-all duration-200 focus:outline-none focus:border-emerald-400 focus:ring-4 focus:ring-emerald-500/15 placeholder:text-[#52525b] placeholder:font-medium resize-y" placeholder="Campaign ini bertujuan mempromosikan produk Skincare X varian terbaru lewat honest review..." required></textarea>
                    </div>

                    <div class="w-full">
                        <label class="block text-xs font-extrabold text-[#a1a1aa] mb-2 tracking-wide">Isi Konten Harus Begini (Full Brief) <span class="text-emerald-500">*</span></label>
                        ...
                        <textarea name="full_brief" rows="6" class="w-full bg-[#000] border border-[#27272a] rounded-2xl px-5 py-3.5 text-sm text-white font-medium transition-all duration-200 focus:outline-none focus:border-emerald-400 focus:ring-4 focus:ring-emerald-500/15 placeholder:text-[#52525b] placeholder:font-medium resize-y" placeholder="1. Mulai video dengan masalah / pain point (contoh: Jerawat membandel).&#10;2. Masukkan screen recording Shopee Toko Kami.&#10;3. Gunakan hashtag wajib #SkincareX #BebasJerawat di caption." required></textarea>
                    </div>
                    ...
                    <div class="w-full">
                        ...
                        <textarea name="donts" rows="3" class="w-full bg-[#000] border border-[#27272a] rounded-2xl px-5 py-3.5 text-sm text-white font-medium transition-all duration-200 focus:outline-none focus:border-emerald-400 focus:ring-4 focus:ring-emerald-500/15 placeholder:text-[#52525b] placeholder:font-medium resize-y" placeholder="- Jangan sebut merk lain&#10;- Jangan menampilkan harga palsu&#10;- Tidak boleh berkata kotor" required></textarea>
                    </div>

                    <div class="flex flex-col sm:flex-row gap-6 w-full">
                        <div class="flex-1">
                            <label class="block text-xs font-extrabold text-[#a1a1aa] mb-2 tracking-wide">Link Aset/Bahan Eksternal</label>
                            <input type="url" name="assets_url" class="w-full bg-[#000] border border-[#27272a] rounded-2xl px-5 py-3.5 text-sm text-white font-medium transition-all duration-200 focus:outline-none focus:border-emerald-400 focus:ring-4 focus:ring-emerald-500/15 placeholder:text-[#52525b] placeholder:font-medium" placeholder="Google Drive URL untuk foto/video mentahan...">
                        </div>
                        <div class="flex-1">
                    ...
                    <div class="flex flex-col sm:flex-row gap-6 w-full">
                        <div class="flex-1">
                            <label class="block text-xs font-extrabold text-[#a1a1aa] mb-2 tracking-wide">Durasi Video yang Diizinkan <span class="text-emerald-500">*</span></label>
                            <input type="text" name="video_length" class="w-full bg-[#000] border border-[#27272a] rounded-2xl px-5 py-3.5 text-sm text-white font-medium transition-all duration-200 focus:outline-none focus:border-emerald-400 focus:ring-4 focus:ring-emerald-500/15 placeholder:text-[#52525b] placeholder:font-medium" placeholder="Contoh: 30 - 60 Detik" required>
                        </div>
                        <div class="flex-1">
                            <label class="block text-xs font-extrabold text-[#a1a1aa] mb-2 tracking-wide">URL / Link Target Konversi <span class="text-emerald-500">*</span></label>
                            <input type="url" name="link" class="w-full bg-[#000] border border-[#27272a] rounded-2xl px-5 py-3.5 text-sm text-white font-medium transition-all duration-200 focus:outline-none focus:border-emerald-400 focus:ring-4 focus:ring-emerald-500/15 placeholder:text-[#52525b] placeholder:font-medium" placeholder="Link Affiliate / Link Toko yang dicantumkan kreator" required>
                        </div>
                    </div>
                    
                    <div class="w-full">
                        <label class="block text-xs font-extrabold text-[#a1a1aa] mb-2 tracking-wide">Platform Sosmed yang Diterima</label>
                        <select name="platform" class="w-full bg-[#000] border border-[#27272a] rounded-2xl px-5 py-3.5 text-sm text-white font-medium transition-all duration-200 focus:outline-none focus:border-emerald-400 focus:ring-4 focus:ring-emerald-500/15 cursor-pointer appearance-none">
            ...
            <div class="p-6 lg:p-8 space-y-8 bg-[#0a0a0a]">
                <div class="flex items-center gap-4">
                    <div class="w-10 h-10 rounded-xl bg-emerald-500/10 flex items-center justify-center border border-emerald-500/20 text-emerald-400 font-black text-lg shrink-0">3</div>
                    <div>
                ...
                {{-- Alert Info Escrow --}}
                <div class="rounded-xl p-5 flex gap-4 items-start relative overflow-hidden bg-emerald-500/5 border border-emerald-500/20">
                    <div class="absolute right-0 top-0 bottom-0 w-32 bg-gradient-to-l from-emerald-500/10 to-transparent pointer-events-none"></div>
                ...
                <div class="flex flex-col md:flex-row gap-6 w-full relative">
                    <div class="flex-1">
                        <label class="block text-xs font-extrabold text-[#a1a1aa] mb-2 tracking-wide">Deposit Total Campaign<span class="text-emerald-500">*</span></label>
                        <div class="relative">
                            <span class="absolute left-4 top-1/2 -translate-y-1/2 text-emerald-500 font-bold text-sm">Rp</span>
                            <input type="number" name="budget" class="w-full bg-[#000] border border-[#27272a] rounded-2xl px-5 py-3.5 text-sm text-white font-medium transition-all duration-200 focus:outline-none focus:border-emerald-400 focus:ring-4 focus:ring-emerald-500/15 placeholder:text-[#52525b] placeholder:font-medium font-black text-lg tracking-wide pl-12" placeholder="0" min="0" required>
                        </div>
                    </div>

                    <div class="flex-1">
                        <label class="block text-xs font-extrabold text-[#a1a1aa] mb-2 tracking-wide">Rate Bidding per 1000 Views<span class="text-emerald-500">*</span></label>
                        <div class="relative">
                            <span class="absolute left-4 top-1/2 -translate-y-1/2 text-emerald-500 font-bold text-sm">Rp</span>
                            <input type="number" name="price_per_1k" class="w-full bg-[#000] border border-[#27272a] rounded-2xl px-5 py-3.5 text-sm text-white font-medium transition-all duration-200 focus:outline-none focus:border-emerald-400 focus:ring-4 focus:ring-emerald-500/15 placeholder:text-[#52525b] placeholder:font-medium font-black text-lg tracking-wide pl-12" placeholder="0" min="0" required>
                        </div>
                    </div>
                </div>
            ...
            <div class="p-6 bg-[#050505] border-t border-white/5 flex flex-col sm:flex-row items-center justify-end gap-3 sticky bottom-0 z-20 shadow-[0_-15px_40px_rgba(0,0,0,0.8)]">
                ...
                <button type="submit" name="action" value="active" class="bg-gradient-to-br from-emerald-600 to-green-600 text-white px-10 py-3.5 rounded-2xl text-sm font-extrabold inline-flex items-center justify-center gap-2 transition-all duration-200 shadow-[0_8px_20px_rgba(5,150,105,0.25)] hover:shadow-[0_8px_30px_rgba(5,150,105,0.4)] hover:-translate-y-0.5 cursor-pointer border-none outline-none w-full sm:w-auto shadow-[0_0_20px_rgba(16,185,129,0.2)]">
