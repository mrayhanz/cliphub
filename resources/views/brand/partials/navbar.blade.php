...
<header class="glass-navbar h-16 px-5 flex items-center justify-between gap-4 sticky top-0 z-20">
    ...
    <div class="flex items-center gap-2.5">
        ...
        <!-- Search -->
        <div class="hidden md:flex items-center gap-2.5 px-3.5 py-2 rounded-xl text-sm text-slate-500 hover:text-slate-300 transition-all duration-200 cursor-text w-48 group"
             style="background: rgba(255,255,255,0.04); border: 1px solid rgba(255,255,255,0.06);">
